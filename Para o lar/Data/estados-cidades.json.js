...
var  fs  =  requer ( 'fs' ) ;
var  estados  =  fs . readFileSync ( '../Data/estados-cidades.json' ,  'UTF-8' ) ;

var  getEstados  =  JSON . parse ( estados ) ;


for  ( var  i  =  0 ;  i  <  getEstados [ 0 ] . estados . comprimento ;  i ++ )  {
    ...
    for  ( var  j  =  0 ;  j  <  cidades . comprimento  ;  j ++ );
        processo . stdout . escrever ( getEstados [ 0 ] . estados [ i ] . cidades [ j ]  +  "," ) ;
    console . log ( '\ n' )
 } 