...
for (let i=0; i < obj.length; i++){ //aqui passa por toda lista de objeto
    let filmes = obj[i]; //atribuindo o nome movie a unidade do objeto
    console.log(filmes.title) //apresentando no console o valor do atributo title
    console.log(filmes.plot) //apresentando no console o valor do atributo plot
    console.log(filmes.genre)//apresentando no console o valor do atributo genre
    console.log(filmes.language)//apresentando no console o valor do atributo language
